        ...
        <div class="col-md-4 p-3">
            <div class="card">
                <div class="card-body">
                    ...
                    if ($_POST){
                        (int)$berat_badan =  ($_POST["berat_badan"]);
                        (int)$tinggi_badan = ($_POST["tinggi_badan"]);
                        (int)$tinggi_badan_fix = (int)$tinggi_badan/100;
                        (int)$hasil = (int)$berat_badan/((int)$tinggi_badan_fix * $tinggi_badan_fix);
                        ...
                        } catch (DivisionByZeroError $tinggi_badan) {
                            echo "Height and weight cannot be empty";
                        } catch (DivisionByZeroError $berat_badan) {
                            echo "Height and weight cannot be empty";
                        }
                    }
